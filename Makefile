# This Makefile is for the Language::VBParser extension to perl.
#
...
#	NAME => q[Language::VBParser]
#	PREREQ_PM => { Parse::RecDescent=>q[1.80] }
#	VERSION => q[0.01]
#	VERSION_FROM => q[VBParser.pm]
...
DISTNAME = Language-VBParser
NAME_SYM = Language_VBParser
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib\bin
...
FULLEXT = Language\VBParser
BASEEXT = VBParser
PARENT_NAME = Language
DLBASE = $(BASEEXT)
VERSION_FROM = VBParser.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
EXPORT_LIST = VBParser.def

PERL_ARCHIVE = $(PERL_INC)\perl56.lib

TO_INST_PM = VBParser.pm

PM_TO_BLIB = VBParser.pm \
	$(INST_LIBDIR)\VBParser.pm
...
VBParser.def: Makefile.PL
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME' => 'Language::VBParser', 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f $(INST_LIBDIR)\VBParser.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Language-VBParser\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>Language-VBParser</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Parse-RecDescent\" VERSION=\"1,80,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Language-VBParser.ppd
